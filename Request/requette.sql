...
SELECT vehicules.id_vehicule,matricule, jour_depart, heure_depart from voyage INNER JOIN utiliser on voyage.id_voyage=utiliser.id_voyage inner JOIN vehicules on vehicules.id_vehicule=utiliser.id_vehicule where jour_depart=current_date();
